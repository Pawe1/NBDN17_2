...
using TrainingPrep.MovieLibrarySpecs;
using TrainingPrep.DSL;

namespace TrainingPrep.MovieLibrarySpecs
{
    ...
    public class when_counting_the_number_of_movies : movie_library_concern
    {
        ...
        Establish context = () =>
            movie_library_concern.movie_collection.add_all(new Movie(), new Movie());
    ...
    public class when_asked_for_all_of_the_movies : movie_library_concern
    {
        ...
        Establish context = () =>
        {
            ...
            movie_library_concern.movie_collection.add_all(first_movie, second_movie);
        };
    ...
    public class when_adding_an_existing_movie_in_the_collection_again : movie_library_concern
    {
        ...
        {
            movie = new Movie();
            movie_library_concern.movie_collection.Add(movie);
        };
